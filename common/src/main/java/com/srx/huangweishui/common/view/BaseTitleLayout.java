...
public class BaseTitleLayout extends RelativeLayout {
    ...
    private void initView() {
        View view = LayoutInflater.from(mContext).inflate(R.layout.base_title_layout_ui, this,
                true);
    ...
    private void initParamas(AttributeSet attrs) {
        TypedArray typedArray = mContext.obtainStyledAttributes(attrs, R.styleable
                .base_title_layout_styeable_ui);
        if (typedArray != null) {
            title_content=typedArray.getString(R.styleable.base_title_layout_styeable_ui_base_title_content);
            title_color = typedArray.getColor(R.styleable
                    .base_title_layout_styeable_ui_base_title_color_ui, mContext.getResources()
                    .getColor(R.color.base_context_color_ui));
            right_text_color = typedArray.getColor(R.styleable
                    .base_title_layout_styeable_ui_base_title_right_text_color, mContext
                    .getResources().getColor(R.color.base_context_color_ui));
            title_size = typedArray.getDimension(R.styleable
                    .base_title_layout_styeable_ui_base_title_size_ui, mContext.getResources()
                    .getDimension(R.dimen.text_size18sp));
            right_text_size = typedArray.getDimension(R.styleable
                    .base_title_layout_styeable_ui_base_title_right_text_size, mContext
                    .getResources().getDimension(R.dimen.text_size15sp));
            base_title_return_ui_visible = typedArray.getBoolean(R.styleable
                    .base_title_layout_styeable_ui_base_title_left_return_ui_visible, true);
            second_image_ui_visible = typedArray.getBoolean(R.styleable
                    .base_title_layout_styeable_ui_base_title_right_second_image_ui_visible, false);
            right_image_ui_visible = typedArray.getBoolean(R.styleable
                    .base_title_layout_styeable_ui_base_title_right_image_ui_visible, false);
            base_title_return_ui_drawbleid = typedArray.getResourceId(R.styleable
                    .base_title_layout_styeable_ui_base_title_left_return_ui, R.drawable
                    .nav_icon_back);
            second_image_ui_drawbleid = typedArray.getResourceId(R.styleable
                    .base_title_layout_styeable_ui_base_title_right_second_image_ui, -1);
            right_image_ui_drawbleid = typedArray.getResourceId(R.styleable
                    .base_title_layout_styeable_ui_base_title_right_image_ui, -1);
            ...
            if (base_title_return_ui_drawbleid > 0) {
                ImageLoderUtil.loadImage(base_title_return_ui_drawbleid,
                        base_title_return_ui);
            ...
            if (second_image_ui_drawbleid > 0) {
                ImageLoderUtil.loadImage( second_image_ui_drawbleid,
                        second_image_ui);
            }
            if (right_image_ui_drawbleid > 0) {
                ImageLoderUtil.loadImage(right_image_ui_drawbleid, right_image_ui);
            }
            if(!TextUtils.isEmpty(title_content)){
                setTitle(title_content);
            }
    ...
    public void setBaseTitleReturnUi(int drawbleid) {
        if (base_title_return_ui != null) {
            ImageLoderUtil.loadImage( drawbleid, base_title_return_ui);
        }
    }

    public void setRightImage(int drawbleid) {
        if (right_image_ui != null) {
            ImageLoderUtil.loadImage( drawbleid, right_image_ui);
        }
    }

    public void setSecondRightImage(int drawbleid) {
        if (second_image_ui != null) {
            ImageLoderUtil.loadImage( drawbleid, second_image_ui);
        }
    }
    ...
    public void setRightTextVisible(int visible) {
        if (title_right_text_ui != null) {
            title_right_text_ui.setVisibility(visible);
        }
    }

    public void setRightTextColor(int resId) {
        if (title_right_text_ui != null) {
            title_right_text_ui.setTextColor(resId);
        }
    }

    public void setRightTextSize(float size) {
        if (title_right_text_ui != null) {
            title_right_text_ui.setTextSize(size);
        }
    }

    public void setRightTextClickable(boolean clik) {
        if (title_right_text_ui != null) {
            title_right_text_ui.setEnabled(clik);
        }
    }
}
